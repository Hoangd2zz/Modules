...
module.exports.run = async function({ api, event, Users }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		...
		return api.sendMessage(`Đ𝑎̃ 𝑘𝑒̂́𝑡 𝑛𝑜̂́𝑖 𝑡ℎ𝑎̀𝑛ℎ 𝑐𝑜̂𝑛𝑔 🤡! 𝐵𝑜𝑡 𝑛𝑎̀𝑦 𝑑𝑜 𝑎𝑖 đ𝑜́ 𝑡𝑎̣𝑜 𝑟𝑎 𝑣𝑎̀ 𝐵𝑦𝑝𝑎𝑠𝑠 Khoa by Khoa Bao Ngầu 🥳\n𝑉𝑎̀ 𝑏𝑜𝑡 đ𝑎𝑛𝑔 đ𝑢̛𝑜̛̣𝑐 𝑠𝑢̛̉ 𝑑𝑢̣𝑛𝑔 𝑏𝑜̛̉𝑖 𝑁𝑔𝑢𝑦𝑒̂̃𝑛 Phạm Anh Khoa 😍\n𝐷𝑢̀𝑛𝑔 𝑙𝑒̣̂𝑛ℎ !menu đ𝑒̂̉ 𝑏𝑖𝑒̂́𝑡 𝑐𝑎́𝑐 𝑙𝑒̣̂𝑛ℎ <3`, threadID);
	}
	else {
		try {
